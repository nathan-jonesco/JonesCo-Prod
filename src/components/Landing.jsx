...
export default function Example() {
  return (
    <div className="grid grid-cols-1 place-content-center gap-6 p-10 sm:h-screen">
      <div className="">
        <h1 className="text-center font-fugaz text-3xl sm:text-6xl">
          JONES CO.
        </h1>
        <h2 className="-mt-1 text-center font-fugaz text-xl sm:text-3xl">
          AUTOMOTIVE
        </h2>
      </div>
