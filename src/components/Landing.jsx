...
const category = [
  ...
  },
  {
    ...
    imageClass:
      'p-8 sm:invisible visible relative flex place-content-center items-center space-x-3 rounded-3xl border border-gray-600 bg-gradient-to-br from-gray-200 to-gray-400 p-2 shadow-sm focus-within:ring-2 focus-within:ring-gray-500 focus-within:ring-offset-2',
  },
]
